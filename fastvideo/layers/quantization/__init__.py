...
QuantizationMethods = Literal[None, "AbsMaxFP8", "FP8", "NVFP4", "nvfp4_lingbot", "nvfp4_qat", "nvfp4_qat_train", "fp8_qat_train"]
...
def get_quantization_config(quantization: str) -> type[QuantizationConfig]:
    ...
    from .nvfp4_config import LingBotWorldNVFP4Config, NVFP4Config
    ...
    method_to_config: dict[str, type[QuantizationConfig]] = {
        ...
        "FP8": FP8Config,
        "NVFP4": NVFP4Config,
        "nvfp4_lingbot": LingBotWorldNVFP4Config,
